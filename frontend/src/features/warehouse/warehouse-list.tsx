...
import { useGetWarehousesPaginated } from "@/hooks/use-warehouse";
...
export default function WarehouseList() {
  ...
  const { data: paginatedData, isLoading, error } = useGetWarehousesPaginated(page, limit, true);
  const { setSelectedWarehouse } = useWarehouseStore();

  // Extract warehouses - handle both paginated and non-paginated responses
  const warehouses = paginatedData?.items || (Array.isArray(paginatedData) ? paginatedData : []);
